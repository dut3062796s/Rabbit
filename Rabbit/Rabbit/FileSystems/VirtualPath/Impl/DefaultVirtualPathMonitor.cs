...
namespace Rabbit.FileSystems.VirtualPath.Impl
{
    internal sealed class DefaultVirtualPathMonitor : IVirtualPathMonitor
    {
        ...
        public DefaultVirtualPathMonitor(IVirtualPathProvider virtualPathProvider)
        {
        ...
        private void BindSignal(string virtualPath, CacheItemRemovedCallback callback)
        {
            ...
            {
                cacheDependency = new CacheDependency(new[] { _virtualPathProvider.MapPath(virtualPath) }, new[] { virtualPath }, DateTime.Now);
            }
